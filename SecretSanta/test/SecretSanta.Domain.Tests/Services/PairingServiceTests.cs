...
namespace SecretSanta.Domain.Tests.Services
{
    ...
    public class PairingServiceTests : DatabaseServiceTests
    {
        ...
        [TestMethod]
        public async Task GeneratePairings_SuccessfullyWithOddNumberOfUser()
        {
            using (var context = new ApplicationDbContext(Options))
            {
                var userService = new UserService(context);
                ...
                Assert.IsTrue(pairings.Count == 3);
            }
        }
        ...
        [TestMethod]
        public async Task AddPairingsToGroup_Then_GetAllPairingsForGroup()
        {
            using (var context = new ApplicationDbContext(Options))
            {
                var userService = new UserService(context);
                ...
                var fetchedPairings = await pairingService.GetPairingsForGroup(1);

                Assert.IsTrue(fetchedPairings.Count == 4);
            }
        }
    }
}
