...
namespace SecretSanta.Api.Tests.Controllers
{
    ...
    public class PairingControllerTests 
    {
        ...
        public async Task BuildPairingForAGroup_Ok()
        {
            ...
            OkResult result = await controller.MakePairings(group.Id).ConfigureAwait(false) as OkResult;
        ...
        public async Task BuildPairingForAGroup_BadRequest_GroupNotFound()
        {
            ...
            BadRequestResult result = await controller.MakePairings(group.Id + 1).ConfigureAwait(false) as BadRequestResult;
        ...
        public async Task BuildPairingForAGroup_BadRequest_DueToTooFew()
        {
            ...
            BadRequestObjectResult result = await controller.MakePairings(0).ConfigureAwait(false) as BadRequestObjectResult;
