...
namespace SecretSanta.Api.Tests.Controllers
{
    ...
    public class GroupControllerTests
    {
        ...
        public async Task DeleteGroup_RequiresPositiveId(int groupId)
        {
            ...
            var result = await controller.DeleteAsync(groupId);
        ...
        public async Task DeleteGroup_ReturnsNotFoundWhenTheGroupFailsToDelete()
        {
            ...
            var result = await controller.DeleteAsync(2);
        ...
        private static async Task AssertAreEqual(GroupViewModel expected, Group actual)
        {
