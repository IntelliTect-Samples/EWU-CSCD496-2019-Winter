...
namespace SecretSanta.Api.Tests.Controllers
{
    ...
    {
        [TestMethod]
        public async Task GetAllGroups_ReturnsGroupsAsync()
        {
        ...
        [TestMethod]
        public async Task CreateGroup_RequiresGroupAsync()
        {
        ...
        [TestMethod]
        public async Task CreateGroup_ReturnsCreatedGroupAsync()
        {
        ...
        [TestMethod]
        public async Task UpdateGroup_RequiresGroupAsync()
        {
            var service = new Mock<IGroupService>(MockBehavior.Strict);
            var controller = new GroupsController(service.Object, Mapper.Instance);
        ...
        [TestMethod]
        public async Task UpdateGroup_ReturnsUpdatedGroupAsync()
        {
            var group = new GroupInputViewModel
            {
                Name = "Group"
        ...
        [DataRow(-1)]
        [DataRow(0)]
        public async Task DeleteGroup_RequiresPositiveIdAsync(int groupId)
        {
            var service = new Mock<IGroupService>(MockBehavior.Strict);
            var controller = new GroupsController(service.Object, Mapper.Instance);
