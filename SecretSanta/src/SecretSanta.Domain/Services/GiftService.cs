...
namespace SecretSanta.Domain.Services
{
    public class GiftService : IGiftService
    {
        ...
        {
            var retrievedGift = await DbContext.Gifts.SingleOrDefaultAsync(g => g.Id == giftId).ConfigureAwait(false);
        ...
        {
            var giftToDelete = await DbContext.Gifts.FindAsync(giftId).ConfigureAwait(false);
